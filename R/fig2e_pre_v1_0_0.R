...
# Built from joining CV R^2 across stages (see notebook lines ~2378-2400).
...
# CV R^2 for a lasso-selected interaction formula.
...
if (sys.nframe() == 0L) {
    ...
    stage3  <- readRDS(here("data/stage3_results_residuals_20250805.rds"))
    ...
    stage3_input_df <- stage3_residuals %>%
