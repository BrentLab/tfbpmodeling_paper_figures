...
#
# Run via:
#   Rscript R/prepare_results_data_v1.R
#
...
#   source(here("R/prepare_results_data_v1.R"))
#
...
if (!exists("results_src_dir"))      results_src_dir      <- here("data/v1_0_0_stage3_bootstrap_lassocv_results")

data_pull_date       <- "20250805"
variant              <- "residuals"
tfbpmodeling_version <- "1.0.0"
results_src_dir      <- "~/htcf_ref/data/yeast_database_modelling/results/20250805/v1.0.0/results_20250805_residuals"
...
# =============================================================================
message("=== prepare_results_data_v1.R complete ===")
